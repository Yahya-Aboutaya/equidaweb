...
<section class="grid-section">
    ...
    <div class="cards">
        ...
        <a class="card" href="<%= request.getContextPath() %>/cheval-servlet/list">
            ...
            <div class="card-desc">Consulter la liste complète des chevaux, accéder aux fiches détaillées et ajouter de nouveaux équidés.</div>
        ...
        <a class="card" href="<%= request.getContextPath() %>/vente-servlet/list">
            ...
            <div class="card-desc">Gérer les ventes aux enchères, consulter les lots associés et créer de nouvelles sessions de vente.</div>
            <span class="card-badge">→ Voir la liste</span>
        </a>
        ...
        <a class="card" href="<%= request.getContextPath() %>/cheval-servlet/add">
            ...
            <div class="card-desc">Enregistrer un nouveau cheval avec son nom, sa race, sa date de naissance et sa généalogie.</div>
        ...
        <a class="card" href="<%= request.getContextPath() %>/vente-servlet/add">
            ...
            <div class="card-desc">Créer une nouvelle vente aux enchères en définissant le lieu, la date et les paramètres associés.</div>
            <span class="card-badge">→ Formulaire</span>
        </a>
